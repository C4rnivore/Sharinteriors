...
function Header() {
  ...
  const { handleAbout, handleProjects, handleContacts } =
    useHomeTransition(500);
  ...
  return (
    <>
      <div id={"main-header"} className="header-container">
        <header
          className={homePage ? "header-el" : "header-el header-m-toggled"}
        >
          <button
            ...
            className={
              homePage
                ...
                : "mobile-menu-toggle-btn mobile-btn-left"
            }
          >
