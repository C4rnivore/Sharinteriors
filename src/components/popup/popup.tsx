...
import { emailJSpublicKey, emailJStemplateID, emailJSserviceID, mailTo } from '@/lib/constants/constants';
...
function Popup() {
    ...
    const handlePopupBgClick = (e: React.MouseEvent<Element, MouseEvent>) => {
        if(e.target instanceof HTMLElement && e.target.className === 'popup-wrapper popup-show'){
