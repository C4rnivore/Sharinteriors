...
import fragmentShader from '@/lib/three_distortion/shaders/fragment.jsx'
import vertexShader from "@/lib/three_distortion/shaders/vertex.jsx";
...
export default class Sketch {
  constructor(options) {
    ...
    //передача контейнера через параметры
    ...
    // добавление элемента рендера в контейнер
