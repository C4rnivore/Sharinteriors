    ...
    return (
      <footer className="mobile-footer">
        ...
        <div className="mobile-menu-content-bottom">
          <ul>
            <li>
              <a target="_blank" href={`tel:${phoneRef}`}>
                {phoneLabel}
              </a>
            </li>
            <li>
              <a target="_blank" href={`mailto:${gmail}`}>
                {gmail}
              </a>
            </li>
          </ul>
  ...
  return (
    <footer>
      <div className="footer-content">
        ...
        <ul>
          <li>
            <a target="_blank" href={vkLink} className="header-nav-a">
              vk.com
            </a>
          </li>
          <li>
            <a target="_blank" href={waLink} className="header-nav-a">
              whatsapp
            </a>
          </li>
          <li>
            <a target="_blank" href={tgLink} className="header-nav-a">
              telegram
            </a>
          </li>
          <li>
            <a target="_blank" href={inLink} className="header-nav-a">
              {t("contacts-inst")}
            </a>
          </li>
        </ul>
      ...
      <div
        className={
          i18n.language === "ru"
            ? "footer-bottom f-b-ru"
            : "footer-bottom f-b-en"
        }
      >
        <div className="contact-link-conatiner footer-contact-link">
          <PopupInitBtn />
