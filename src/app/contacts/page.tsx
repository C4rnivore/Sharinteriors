          ...
          <div className="contacts">
            <div className="contacts-top">
              ...
              <div className="top-data">
                <a className="header-nav-a" href={`tel:${phoneRef}`}>
                  {phoneLabel}
                </a>
                <a className="header-nav-a" href={`mailto:${gmail}`}>
                  {gmail}
                </a>
              </div>
            </div>
            ...
            <div className="contacts-bottom">
              <ul className="contacts-list-desc">
                <li>
                  <a target="_blank" className="header-nav-a" href={vkLink}>
                    vk.com
                  </a>
                </li>
                <li>
                  <a target="_blank" className="header-nav-a" href={waLink}>
                    whatsapp
                  </a>
                </li>
                <li>
                  <a target="_blank" className="header-nav-a" href={tgLink}>
                    telegram
                  </a>
                </li>
                <li>
                  <a target="_blank" className="header-nav-a" href={inLink}>
                    {t("contacts-inst")}
                  </a>
                </li>
              </ul>
