  ...
  return (
    <>
      ...
      <p>
        ...
        <strong>Шарков Александр</strong> (далее – Оператор).
      </p>
      <p>
      ...
      <p>
        ...
        Оператор может получить о посетителях веб-сайта Sharinterior.
      </p>
      ...
      <p>
        ...
        сете интернет по сетевому адресу Sharinterior.
      </p>
      <p>
      ...
      <p>2.10. Пользователь – любой посетитель веб-сайта Sharinterior.</p>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          материалам, содержащимся на веб-сайте Sharinterior.
        </li>
      </ul>
      <p>
        ...
        почты «придумать ссылку» с пометкой «Отказ от уведомлений о новых
      ...
      <p>
        ...
        специальные формы, расположенные на сайте Sharinterior или направленные
      ...
      <p>
        ...
        уведомление на адрес электронной почты Оператора «придумать сайт» с
      ...
      <p>
        ...
        электронной почты на электронный адрес Оператора «придумать сайт» с
      ...
      <p>
        ...
        Оператору с помощью электронной почты «придумать сайт».
      </p>
      <p>
      ...
      <p>
        ...
        Интернет по адресу https://sharinteriors.com/terms/.
      </p>
    </>
  );
}
